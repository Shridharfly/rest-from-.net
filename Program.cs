...
namespace REST_from.NET
{
    ...
    class Program
    {
        static readonly string endpoint = ""; //todo
        static readonly string masterKey = ""; //todo
        ...
        static readonly string databaseId = "";//todo
        static readonly string collectionId = "";//todo
        static readonly string documentId = "";//todo
